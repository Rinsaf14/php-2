...
<body>
    ...
    <?php "<h3>Soal No. 1 Looping I love PHP</h3>";
    /*
        Soal No. 1
        Looping I Love PHP
        Lakukan perulangan (boleh for/while/do while) sebanyak 20 literasi. Looping terbagi menjadi dua: Looping pertama Ascending (meningkat) dan Looping Kedua Descending (menurun). 
        Output: 
        LOOPING PERTAMA
        2 - I Love PHP
        4 - I Love PHP  
...
`
    ...
    */
    ...
    // Menampilkan hasil
    foreach ($associativeItems as $product) {
        echo '<pre>';
        print_r($product);
        echo '</pre>';
    }
